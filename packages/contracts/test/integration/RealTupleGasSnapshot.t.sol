...
contract RealTupleGasSnapshotTest is Test {
    ...
    ///         `def6270` from 600K → **2.5M** based on empirical real-tuple
    ///         measurement). Current measured cost is ~2.02M, so 2.5M
    ///         leaves ~25% regression margin. Composition:
    ...
    function test_real_tuple_full_register_gas() public {
        ...
        // 2.5M cap with empirical 2.02M leaves ~25% regression margin.
