...
contract ZkqesRegistryV4Test is Test {
    ...
    function test_non_admin_cannot_rotate() public {
        ...
        vm.expectRevert(ZkqesRegistryV4.OnlyAdmin.selector);
        r.setTrustedListRoot(bytes32(uint256(0x999)));
    }
    ...
    function _deploy() private returns (ZkqesRegistryV4) {
        return new ZkqesRegistryV4({
            country_: "UA",
            trustedListRoot_: bytes32(uint256(0x123)),
            policyRoot_: bytes32(uint256(0x456)),
            leafVerifier_: address(0x1111),
    ...
    function _deployForRegister()
        private
        returns (ZkqesRegistryV4 r, MockLeafV lv, MockChainV cv)
    {
        lv = new MockLeafV();
        cv = new MockChainV();
        r = new ZkqesRegistryV4({
            country_: "UA",
    ...
    function _emptyProof() private pure returns (ZkqesRegistryV4.G16Proof memory p) {
    ...
    function _chainProof(uint256 rTL, uint256 algorithmTag, uint256 spki)
        private pure returns (ZkqesRegistryV4.ChainProof memory cp)
    {
    ...
    ) private pure returns (ZkqesRegistryV4.LeafProof memory lp, address pkAddr) {
    ...
    function test_register_happy_path_stores_binding() public {
        (ZkqesRegistryV4 r,,) = _deployForRegister();
        ZkqesRegistryV4.ChainProof memory cp = _chainProof(_RTL_VAL, 0, _SPKI_VAL);
        (ZkqesRegistryV4.LeafProof memory lp, address pkAddr) =
    ...
    function test_register_records_dobAvailable_when_supported() public {
        (ZkqesRegistryV4 r,,) = _deployForRegister();
        ZkqesRegistryV4.ChainProof memory cp = _chainProof(_RTL_VAL, 1, _SPKI_VAL);
        (ZkqesRegistryV4.LeafProof memory lp,) =
    ...
    function test_register_reverts_on_root_mismatch() public {
        (ZkqesRegistryV4 r,,) = _deployForRegister();
        ZkqesRegistryV4.ChainProof memory cp = _chainProof(_RTL_VAL + 1, 0, _SPKI_VAL);
        (ZkqesRegistryV4.LeafProof memory lp,) =
            _leafProof(_POLICY_VAL, _SPKI_VAL, _NULLIFIER_VAL, 0, 0);
        vm.expectRevert(ZkqesRegistryV4.NotOnTrustedList.selector);
        r.register(cp, lp);
    }
    ...
    function test_register_reverts_on_leafSpkiCommit_mismatch() public {
        ...
        vm.expectRevert(ZkqesRegistryV4.InvalidLeafSpkiCommit.selector);
        r.register(cp, lp);
    }
    ...
    function test_register_reverts_on_policyRoot_mismatch() public {
        ...
        vm.expectRevert(ZkqesRegistryV4.InvalidPolicyRoot.selector);
        r.register(cp, lp);
    }

    function test_register_reverts_on_bad_algorithmTag() public {
        (ZkqesRegistryV4 r,,) = _deployForRegister();
        ZkqesRegistryV4.ChainProof memory cp = _chainProof(_RTL_VAL, 2, _SPKI_VAL);
        (ZkqesRegistryV4.LeafProof memory lp,) =
            _leafProof(_POLICY_VAL, _SPKI_VAL, _NULLIFIER_VAL, 0, 0);
        vm.expectRevert(ZkqesRegistryV4.AlgorithmNotSupported.selector);
        r.register(cp, lp);
    }
    ...
    function test_register_reverts_on_duplicate_nullifier() public {
        ...
        (ZkqesRegistryV4.LeafProof memory lp,) =
            _leafProof(_POLICY_VAL, _SPKI_VAL, _NULLIFIER_VAL, 0, 0);
        r.register(cp, lp);
        vm.expectRevert(ZkqesRegistryV4.DuplicateNullifier.selector);
        r.register(cp, lp);
    }

    function test_register_reverts_on_chain_verifier_false() public {
        (ZkqesRegistryV4 r, , MockChainV cv) = _deployForRegister();
        cv.setResult(false);
        ZkqesRegistryV4.ChainProof memory cp = _chainProof(_RTL_VAL, 0, _SPKI_VAL);
        (ZkqesRegistryV4.LeafProof memory lp,) =
            _leafProof(_POLICY_VAL, _SPKI_VAL, _NULLIFIER_VAL, 0, 0);
        vm.expectRevert(ZkqesRegistryV4.InvalidProof.selector);
        r.register(cp, lp);
    }

    function test_register_reverts_on_leaf_verifier_false() public {
        (ZkqesRegistryV4 r, MockLeafV lv,) = _deployForRegister();
        lv.setResult(false);
        ZkqesRegistryV4.ChainProof memory cp = _chainProof(_RTL_VAL, 0, _SPKI_VAL);
        (ZkqesRegistryV4.LeafProof memory lp,) =
            _leafProof(_POLICY_VAL, _SPKI_VAL, _NULLIFIER_VAL, 0, 0);
    ...
    function _deployForAge()
        private
        returns (ZkqesRegistryV4 r, MockLeafV lv, MockChainV cv, MockAgeV av)
    {
        lv = new MockLeafV();
        cv = new MockChainV();
        av = new MockAgeV();
    ...
    function _registerDobBinding(ZkqesRegistryV4 r) private returns (bytes32 id) {
        ZkqesRegistryV4.ChainProof memory cp = _chainProof(_RTL_VAL, 0, _SPKI_VAL);
        (ZkqesRegistryV4.LeafProof memory lp,) =
    ...
    function _ageProof(uint256 dobCommit, uint256 cutoff, uint256 qualified)
        private pure returns (ZkqesRegistryV4.AgeProof memory ap)
    {
    ...
    function test_proveAdulthood_happy_path_updates_cutoff() public {
        (ZkqesRegistryV4 r, , , ) = _deployForAge();
        bytes32 id = _registerDobBinding(r);

        ZkqesRegistryV4.AgeProof memory ap = _ageProof(_DOB_COMMIT, _CUTOFF, 1);
        vm.expectEmit(true, false, false, true);
    ...
    function test_proveAdulthood_reverts_when_binding_not_found() public {
        (ZkqesRegistryV4 r, , , ) = _deployForAge();
        ZkqesRegistryV4.AgeProof memory ap = _ageProof(_DOB_COMMIT, _CUTOFF, 1);
        vm.expectRevert(ZkqesRegistryV4.BindingNotFound.selector);
    ...
    function test_proveAdulthood_reverts_when_dob_unavailable() public {
        ...
        ZkqesRegistryV4.AgeProof memory ap = _ageProof(0, _CUTOFF, 1);
        vm.expectRevert(ZkqesRegistryV4.DobNotAvailable.selector);
        r.proveAdulthood(id, ap, _CUTOFF);
    }
    ...
    function test_proveAdulthood_reverts_on_non_monotonic_cutoff() public {
        ...
        ZkqesRegistryV4.AgeProof memory ap2 = _ageProof(_DOB_COMMIT, _CUTOFF - 1, 1);
        vm.expectRevert(ZkqesRegistryV4.NotMonotonic.selector);
    ...
    function test_proveAdulthood_reverts_on_dobCommit_mismatch() public {
        (ZkqesRegistryV4 r, , , ) = _deployForAge();
        bytes32 id = _registerDobBinding(r);
        ZkqesRegistryV4.AgeProof memory ap = _ageProof(_DOB_COMMIT + 1, _CUTOFF, 1);
        vm.expectRevert(ZkqesRegistryV4.AgeProofMismatch.selector);
        r.proveAdulthood(id, ap, _CUTOFF);
    }
    ...
    function test_proveAdulthood_reverts_on_cutoff_mismatch() public {
        (ZkqesRegistryV4 r, , , ) = _deployForAge();
        bytes32 id = _registerDobBinding(r);
        ZkqesRegistryV4.AgeProof memory ap = _ageProof(_DOB_COMMIT, _CUTOFF + 1, 1);
        vm.expectRevert(ZkqesRegistryV4.AgeProofMismatch.selector);
        r.proveAdulthood(id, ap, _CUTOFF);
    }
    ...
    function test_proveAdulthood_reverts_when_not_qualified() public {
        (ZkqesRegistryV4 r, , , ) = _deployForAge();
        bytes32 id = _registerDobBinding(r);
        ZkqesRegistryV4.AgeProof memory ap = _ageProof(_DOB_COMMIT, _CUTOFF, 0);
        vm.expectRevert(ZkqesRegistryV4.AgeNotQualified.selector);
        r.proveAdulthood(id, ap, _CUTOFF);
    }

    function test_proveAdulthood_reverts_on_invalid_age_proof() public {
        (ZkqesRegistryV4 r, , , MockAgeV av) = _deployForAge();
        bytes32 id = _registerDobBinding(r);
        av.setResult(false);
        ZkqesRegistryV4.AgeProof memory ap = _ageProof(_DOB_COMMIT, _CUTOFF, 1);
        vm.expectRevert(ZkqesRegistryV4.InvalidProof.selector);
    ...
    function _registerForWallet(ZkqesRegistryV4 r, Vm.Wallet memory w, uint256 nullifier)
    ...
    function test_revoke_reverts_on_double_revoke() public {
        ...
        vm.expectRevert(ZkqesRegistryV4.BindingRevoked.selector);
    ...
    function test_selfRevoke_with_wrong_signer_reverts() public {
        ...
        vm.expectRevert(ZkqesRegistryV4.SelfRevokeSigInvalid.selector);
        r.selfRevoke(id, sig);
    }
