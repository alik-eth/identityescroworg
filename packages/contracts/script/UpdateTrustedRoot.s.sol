...
/// @notice Admin-only rotation of ZkqesRegistryV3.trustedListRoot. Called when
...
///
///         Required env:
///           REGISTRY_ADDR        address  — deployed ZkqesRegistryV3
...
contract UpdateTrustedRoot is Script {
    function run() external {
        ZkqesRegistryV3 registry = ZkqesRegistryV3(vm.envAddress("REGISTRY_ADDR"));
        ...
        console2.log("ZkqesRegistryV3:", address(registry));
