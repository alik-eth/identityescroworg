// JCS binding-offset extractor for V2Core.
//
// Verbatim port of arch-circuits f0d5a73's `src/binding-offsets.ts`. No
// browser patches needed — uses only `Buffer` (polyfilled) and pure
// scanning logic.
