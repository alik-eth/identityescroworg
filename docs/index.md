...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: 'zkqes.org root →'
      link: 'https://zkqes.org'

features:
  - title: 'Specs'
    details: 'V5 architecture + V5.1 wallet-bound nullifier + V5.2 keccak-on-chain + V5.3 OID-anchor amendments. The frozen public-signal layout, the witness contract, the constraint envelope.'
    link: '/specs/v5-architecture'
  - title: 'Ceremony'
    details: 'Phase B trusted setup — multi-contributor real-Phase-2 over pot22. Coordinator runbook, contributor instructions, attestation chain.'
    link: '/ceremony/'
  - title: 'Reference'
